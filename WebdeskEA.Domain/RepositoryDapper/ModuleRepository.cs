...
namespace WebdeskEA.Domain.RepositoryDapper
{
    public class ModuleRepository : Repository<Module>, IModuleRepository
    {
        ...
        //------ Get -------
        #region Get
        public async Task<IEnumerable<ModuleDto>> GetAllListAsync()
        {
        ...
        public async Task<IEnumerable<ModuleDto>> GetUserSideBarAllDetailByUserId(string UserId)
        {
            var procedure = "spGetUserSidebarDetails";
