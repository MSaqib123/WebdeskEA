...
namespace CRM.Areas.Admin.Controllers
{
    ...
    public class ModulesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            try
            {
                var modules = await _moduleRepo.GetAllListAsync();
                return View(modules);
            }
            catch (Exception ex)
            {
        ...
        public IActionResult Create()
        {
            ...
            Dto.ModuleList = _moduleRepo.GetAllListAsync().Result.ToList();
            return View(Dto);
        }
        ...
        public async Task<IActionResult> Edit(int id)
        {
            try
            {
                ...
                module.ModuleList = _moduleRepo.GetAllListAsync().Result.ToList();
                if (module == null)
                    return NotFound();
